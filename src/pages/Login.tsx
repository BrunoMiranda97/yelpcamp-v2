      ...
      >
        <Card className="p-8 sm:p-10 shadow-2xl rounded-3xl border-slate-200 dark:border-slate-800 transition-colors">
          <div className="mb-10 text-center">
            ...
            <h1 className="text-2xl font-black tracking-tighter text-slate-900 dark:text-slate-100 uppercase">Login Portal</h1>
            <p className="mt-2 text-xs font-bold text-slate-400 uppercase tracking-widest font-mono">Authentication required</p>
          </div>
          ...
          <p className="mt-8 text-center text-[10px] font-bold uppercase tracking-widest text-slate-400 font-mono">
            No account? <Link to="/register" className="text-emerald-600 hover:underline">Create Account</Link>
          </p>
        </Card>
      </motion.div>
    </div>
